...
import './Auth.css'
import icon from '../../assests/queryVerse.png'
import AboutAuth from './AboutAuth'
import { signup, l, login } from '../../actions/auth'
    ...
    <form onSubmit={handleSubmit}>
      ...
      <label htmlFor="password">
       <div style={{display:"flex", justifyContent:"space-between"}}>
        ...
        {isSignup && <p style={{color: "#666767", fontSize:"13px"}}>Password must contain eight <br/>characters, including at least 1 letter and 1<br/> number.</p>}
      </label>
      {isSignup && (
        <label htmlFor='check'>
